...
async function main() {
    ...
    const superAdminPassword = await bcryptjs_1.default.hash('superadmin123456', 12);
    ...
    // Create admin user
    const adminPassword = await bcryptjs_1.default.hash(process.env.ADMIN_PASSWORD || 'admin123456', 12);
    ...
    // Create test user
    const testPassword = await bcryptjs_1.default.hash('test123456', 12);
    ...
    const departments = [
        ...
        },
        {
            name: 'Service',
            phone: '954-893-8115',
            email: 'NCmechanicshop@gmail.com',
    ...
    const faqs = [
        {
            ...
            category: client_1.FAQCategory.SALES,
            sortOrder: 1,
        },
        {
            ...
            category: client_1.FAQCategory.SERVICE,
            sortOrder: 2,
        },
        {
            ...
            category: client_1.FAQCategory.GENERAL,
            sortOrder: 3,
        },
        {
        ...
        },
        {
            ...
            category: client_1.FAQCategory.ACCOUNTING,
            sortOrder: 5,
        },
        {
